...
exports.template = [{
  ...
  submenu: [{
    ...
    click: function (item, focusedWindow) {
      console.info('Creating a new Notebook!');
      console.error('NYI!');
    }
  }, {
    label: 'Save Note',
    ...
    click: function (item, focusedWindow) {
      console.info('Closing current Note!');
...
exports.appleTemplate = {
  ...
  submenu: [{
    ...
    click: function (item, focusedWindow) {
      ...
      console.info("NOT YET COMPLETEY IMPLEMENTED");
    }
  }, {
    label: 'Services',
    role: 'services',
